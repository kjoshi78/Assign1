...
# KNN Classifier
def train_knnclassifier(algo, X_train, y_train, upper_limit=100, step=1):
    upper_limit = upper_limit
    step = step
    k_range = [i for i in range(1, upper_limit, step)]
...
param_grid = {'n_neighbors': range(2, 21)}  # Search for k from 1 to 20
